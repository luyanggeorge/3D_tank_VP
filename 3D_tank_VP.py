...
#   and hat_phi=a Lagrange polynimial constructed with GLL points.
...
if input_data=="measurements":
    ...
    WM_expr(WM_n0, x, t, wm_inter)
    WM_expr(WM_n1, x, t_n1, wm_inter)
...
elif case=='TC2': # save the field data using VertexOnlyMesh
...
while t<Tend: 
    ...
    if t_save-smallfac < t: 
        ...
        if case=='TC1':
            ...
            field_data = np.empty((3142+1,5)) # for convergence analyses
            for row_i in range(3142+1):
                x_i = row_i*(Lx/3142) # x coordinates
