...
| TC3       |**`3D_tank_VP.py`** <br/>`settings_TC3.py`, `savings.py`<br/> :construction: Δt=0.001s: HPC (64 anywhere, JOBID 6006324); <br/>:construction: Δt=0.002s: HPC | **`3D_tank.py`** + `solvers_full.py` <br/>`settings_TC3.py`, `savings.py` <br/> :construction: Δt=0.001s: HPC; <br/> :white_check_mark: Δt=0.002s: Done. 7h(16p-YL). |
