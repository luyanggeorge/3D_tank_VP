...
if scheme=='MMP':
	data_path1='data_VP/MMP/TC1_2D_test(1ele,phiGLL)'
	data_path2='data_VP/MMP/TC1_2D_test(1ele,phiGLL,half-dt)'
	figure_name ='TC0_MMP.png'
else: # scheme=='SV'
	data_path1='data_Re/SV/TC1_2D_test_dt'
	data_path2='data_Re/SV/TC1_2D_test_dt2'
