...
def test_case():
    ...
    save_path = 'data_VP/'+scheme+'/TC2_nz8_CG1/h02_dt2_centre'
    ...
    save_pvd = False
    # Whether or not to save the 3D results into pvd files to be viewed with Paraview
